...
async function main() {
  console.log('Seeding LoomEval Database...');
  ...
  console.log('Generating trace histories...');
  for (let i = 1; i <= 75; i++) {
  ...
  console.log('Seeding test suites & test cases...');
  ...
  console.log('Creating experiment runs...');
  ...
  for (let idx = 0; idx < variants.length; idx++) {
    ...
    // Seed results (only V3 & V4 pass everything, V1 fails, V2 has minor regressions)
    const passed = idx >= 2;
